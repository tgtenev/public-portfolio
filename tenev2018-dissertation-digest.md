...
$$
v_s = (1 + \varepsilon)^{-1}c, \qquad \frac{d\tau}{dt} = (1 + \varepsilon)^{-1}
\tag{3.3–3.4}
$$
...
$$
\begin{pmatrix} x' \\ c\tau' \end{pmatrix} = \gamma \begin{pmatrix} 1 & -\beta \\ -\beta & 1 \end{pmatrix} \begin{pmatrix} x \\ c\tau \end{pmatrix}, \qquad \gamma = \frac{1}{\sqrt{1-\beta^2}}
\tag{4.9, 4.11}
$$
...
$$
ds^2_\text{ext} = -\left(1-\frac{r_s}{\overline{r}}\right) c^2 dt^2 + \left(1+\frac{r_s}{\overline{r}} - \frac{2 r_s r_g^2}{5\overline{r}^3}\right) d\overline{r}^2 + \left(1+\frac{r_s r_g^2}{5\overline{r}^3}\right) \overline{r}^2 d\Omega^2
\tag{5.40}
$$
...
$$
\max |W_\text{M}| = \frac{27 c^4 r_s^2 r_g}{35 G L^2}
\tag{5.47}
$$
...
$$
a(\overline{r}) = -\frac{G M(\overline{r})}{\overline{r}^2}
\tag{6.23}
$$
